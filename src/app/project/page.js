...
function Thira_Project() {
	return (
		<TotalSke>
			...
			<div className="gap">
				<p className="explain">
					이 프로젝트는 Vue 프레임워크와 Blockly 라이브러리를 활용해 AMR에 미션을 생성하고
					수행시키는 프로그램입니다.
					<br />
					해당 프로젝트는 외부 회사에 의해 초기 개발되었으나, 저는 스케줄링을 세부적으로 조율할 수
					있는 두 개의 페이지 기능을 연결하고,
					<br />
					프로젝트 마무리 작업을 함께 진행했습니다.
					<br />
					당시 Vue에 대한 경험이 없었지만, 단기간에 학습하여 프로젝트를 원활히 진행할 수 있었고,
					이후에는 프로젝트 인수인계를 받고
					<br />
					발생하는 이슈 해결 및 추가 개발 사항을 맡아 지속적으로 프로젝트를 개선했습니다.
				</p>
				<p>진행 기간: 2023년 11월 ~ 2024년 1월</p>
				<p>기술 스택: Vue, TypeScript, GitLab</p>
				<hr className="line" />
			</div>
			<h2 style={{ marginTop: '20px' }} className="project_name">
				PORTAL
			...
			<div className="gap">
				<p className="explain">
					한 대의 AMR을 상태를 제어하고 관리할 수 있는 PORTAL 사이트 입니다.
					<br />
					기존 java script로 만들어진 프로젝트를 type script로 변환하는 작업을 하였습니다.
				</p>
				<p>진행 기간: 2023년 9월 ~ 2023년 10월</p>
				<p>기술 스택: TypeScript, React, React-query, GitLab</p>
				<hr className="line" />
			</div>
		</TotalSke>
	);
